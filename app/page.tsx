    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
                ...
                >
                  <div>
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <select
                        className="text-xs bg-[#1a1a1a] text-neutral-400 hover:text-emerald-400 outline-none cursor-pointer border border-[#262626] rounded-lg px-2 py-1 transition-colors"
                        value={p.estado}
                    ...
                    <h3 className="font-bold text-lg text-white leading-tight mb-2 group-hover:text-emerald-400 transition-colors">
                      {p.nombre_pedido}
                    </h3>
                    ...
                    {p.fecha_entrega && (
                      <div
                        className={`flex items-center gap-2 text-xs mb-4 rounded-lg p-3 border ${
                          urgent
                    ...
                    {p.precio_total > 0 && (
                      <div className="mb-4">
                        <div className="flex justify-between text-xs text-neutral-500 mb-2">
                          ...
                          <span className={porcentajePagado === 100 ? "text-emerald-400" : ""}>
                    ...
                    <div className="flex justify-between items-end">
                      ...
                      {deuda > 0 ? (
                        <button
                          ...
                          className="bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-xl text-xs font-bold transition-all hover:shadow-lg hover:shadow-emerald-500/20"
                        >
                          Cobrar
                        </button>
                      ) : (
                        <div className="flex gap-2 items-center">
                          ...
                          <button
                            ...
                            className="text-neutral-600 hover:text-red-400 transition-colors p-2 hover:bg-red-500/10 rounded-lg"
                          >
                            <Trash2 size={18} />
                          </button>
                        </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 z-50">
          <div className="bg-[#111] rounded-2xl w-full max-w-md border border-[#1a1a1a] shadow-2xl shadow-emerald-500/10">
